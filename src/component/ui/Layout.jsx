...
//       {/* Mobile Header */}
//       <div className="bg-white md:hidden fixed top-0 left-0 right-0 bg-card border-border z-50 flex items-center justify-between p-4 shadow-md " style={`${valueFromChild}`==='light'?darkMode:lightMode}>
