...
//     { id: "2", name: "Alex Chen", username: "alexchen" },
//   ];
...
//   // 🔥 FUNCTION TO IDENTIFY AUTHOR OF POST
...
//     // 2️⃣ Followers
//     const fromFollowers = loggedUser.followers?.find(
//       (u) => u._id === postUser._id
//     );
//     if (fromFollowers) {
//       author = {
//         name: fromFollowers.username,
//         avatar: fromFollowers.profilePhoto
//           ? `data:image/jpeg;base64,${fromFollowers.profilePhoto}`
//           : "/default-avatar.png",
//       };
//       return author;
//     }
...
//     // 3️⃣ Following
//     const fromFollowing = loggedUser.following?.find(
//       (u) => u._id === postUser._id
//     );
//     if (fromFollowing) {
//       author = {
//         name: fromFollowing.username,
//         avatar: fromFollowing.profilePhoto
//           ? `data:image/jpeg;base64,${fromFollowing.profilePhoto}`
//           : "/default-avatar.png",
//       };
//       return author;
//     }
