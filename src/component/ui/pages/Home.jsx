...
//     <Layout>
//       {/* HERO */}
//       <div className="relative overflow-hidden py-10 md:py-14 px-4 md:px-8 bg-linear-to-r from-blue-600/10 via-purple-600/10 to-pink-600/10 rounded-b-3xl shadow-sm">
...
//                 // 1️⃣ If post is by logged-in user
//                 if (user?._id === userId) {
//                   details = {
...
//                 // 2️⃣ Check followers
//                 if (details.username === "Unknown User" && user?.followers) {
//                   const match = user.followers.find((f) => f._id === userId);
//                   if (match) details = match;
//                 }

//                 // 3️⃣ Check following
//                 if (details.username === "Unknown User" && user?.following) {
//                   const match = user.following.find((f) => f._id === userId);
//                   if (match) details = match;
//                 }

//                 const author = {
//                   name: details.username || "Unknown User",
//                   avatar: details.profilePhoto
//                     ? `data:image/jpeg;base64,${details.profilePhoto}`
//                     : "/default-avatar.png",
//                 };
...
//         shadow-xl hover:scale-110 transition-all z-50"
//       >
//         <BsPlusLg size={28} />
//       </button>
//     </Layout>
