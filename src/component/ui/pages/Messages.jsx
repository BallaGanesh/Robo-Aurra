...
//   return (
//     <Layout>
//       <div className="flex h-[calc(100vh-96px)] md:h-screen bg-background">
//         {/* Sidebar - Chat List */}
//         <div className="w-full md:w-80 border-r border-border flex flex-col bg-card">
//           {/* Header */}
//           <div className="p-4 border-b border-gray-400 border-border">
//             <h1 className="text-3xl font-bold mb-4 bg-linear-to-r w-33 from-purple-600 to-blue-500 bg-clip-text text-transparent">Messages</h1>
//             <div className="relative bg-gray-300 rounded-3xl">
//               <CiSearch
//                 className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground size-5 text-gray-600 "/>
//               <input
//                 type="text"
//                 value={searchQuery}
//                 onChange={(e) => setSearchQuery(e.target.value)}
...
//                 key={chat.id}
//                 onClick={() => setSelectedChatId(chat.id)}
//                 className={`w-full p-4 border-b border-gray-400 border-border transition-all duration-200 hover:bg-muted/30 ${
//                   selectedChatId === chat.id ? "bg-primary/10" : ""
//                 }`}>
...
//                     {chat.user.isOnline && (
//                       <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-white rounded-full border-2 border-card" />
//                     )}
//                   </div>
...
//         {/* Main Chat Area */}
//         {selectedChat ? (
//           <div className="hidden md:flex md:flex-1 flex-col bg-background">
//             {/* Chat Header */}
...
//                   {selectedChat.user.isOnline && (
//                     <div className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 rounded-full border border-white border-card" />
//                   )}
//                 </div>
//                 <div>
//                   <p className="font-semibold">{selectedChat.user.name}</p>
...
//               <button className="icon-button text-muted-foreground hover:text-foreground">
...
//               style={{
//                 backgroundImage:"url('https://images.unsplash.com/photo-1569163139394-de4798aa62b3?w=400&h=400&fit=crop')",
...
//                         message.isOwn
//                           ? "bg-linear-to-r from-blue-500 to-purple-600 text-white"
//                           : "bg-muted text-foreground bg-gray-300"
//                       }`}>
...
//                 <button className="icon-button text-blue-500 hover:bg-blue-500/10 self-center ">
//                   <FaPlus size={24} />
//                 </button>
...
//                   onKeyDown={(e) => e.key === "Enter" && handleSendMessage()}
//                   placeholder="Aa"
//                   className="flex-1 px-4 py-3 rounded-full bg-muted border-0 bg-gray-300 border-border focus:outline-none focus:ring-2 focus:ring-primary text-foreground placeholder-muted-foreground active:border-blue-500  "/>

//                 {/* <button className="icon-button text-blue-500 hover:bg-blue-500/10">
//                   <Smile size={24} />
//                 </button> */}

//                 <button
//                   onClick={handleSendMessage}
//                   className="icon-button text-white bg-linear-to-r from-blue-500 to-purple-600 hover:shadow-lg hover:shadow-blue-500/30 rounded-full">
//                   <FiSend className="size-10 p-2" />
//                 </button>
//               </div>
//             </div>
//           </div>
