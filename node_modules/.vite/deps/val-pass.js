...
// node_modules/val-pass/index.mjs
function validatePassword(password, length) {
  ...
  return {
    ...
    getAllValidationErrorMessage() {
      ...
      if (length) {
        if (!hasLength) {
          errorObj.push(`${length} character`);
        }
      }
      if (!hasLower) {
        errorObj.push(`Lower case`);
      }
      if (!hasUpper) {
        errorObj.push(`Upper case`);
      }
      if (!hasSpecial) {
        errorObj.push(`special character`);
      }
      if (!hasNoSpace) {
        errorObj.push(`no space`);
      }
      if (!hasNum) {
        errorObj.push(`number`);
      }
      if (errorObj.length) {
...
//# sourceMappingURL=val-pass.js.map
